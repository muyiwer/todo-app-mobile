...
const AddTaskScreen: React.FC<Props> = ({ navigation }) => {
  ...
  return (
    <View style={[styles.container, theme === 'dark' ? styles.darkContainer : styles.lightContainer]}>
      <Text style={[styles.label, theme === 'dark' && styles.darkLabel]}>Title</Text>
      <TextInput
      ...
      />
      {/* ... rest of the UI */}
      <TouchableOpacity style={[styles.saveButton, theme === 'dark' && styles.darkSaveButton]} onPress={handleAddTask}>
